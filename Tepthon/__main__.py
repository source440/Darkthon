...
LOGS = logging.getLogger("ســـورس جميثون")
...
async def startup_process():
    ...
    async def start_bot():
      try:
          List = ["Tepthon","PPYNY","Tepthone1","jemthon","jemthonhelp","jemthon1","jemthon_virs"]
    ...
    LOGS.info(f"⌔ تـم تنصيـب جميثون بنجـاح ✓ \n⌔ لـ إظهـار الأوامــر أرسـل (.الاوامر)")
    await verifyLoggerGroup()
